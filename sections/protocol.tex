...
Sem contar com os algoritmos referidos nas subsecções abaixo, que são uma grande parte o que torna \textit{Signal} seguro, este também usa as primitivas, atualmente, mais seguras.
