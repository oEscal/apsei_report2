...
\title{\vspace{-0.9cm}
       ...
       \vspace{0.5cm}
       \normalsize
       \raggedright\textbf{Titulo: \hspace{1.1cm} Análise dum serviço da Internet: Signal} \\ \vspace{0.4cm}
       \raggedright\textbf{Autores: \hspace{0.8cm} Miguel Martins Mota; Pedro Miguel Nicolau Escaleira; Rafael José Santos Simões} \\ \vspace{0.4cm}
       \raggedright\textbf{Date: \hspace{1.3cm} 21/04/2020} \\}
\author{}
\date{}
